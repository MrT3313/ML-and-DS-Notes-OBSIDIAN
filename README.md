...
| `Sources/` | One note per source, plus one per chapter extracted from it, and one per dataset those chapters work on. Currently HOML (Géron, 2022), chapters 1 and 2, and the California housing dataset. |
