...
- `Operations/` holds two notes and is the thinnest folder in the new domain. Chapter 2's operability material is what decides whether it grows into a folder or whether its two notes belong somewhere else.
